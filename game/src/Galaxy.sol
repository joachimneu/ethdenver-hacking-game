...
contract Galaxy is ERC721, Ownable {
    ...
    function getNumShields(uint256 tokenId) public view returns (uint256) {
    ...
    function getPlanet(uint256 tokenId) public view returns (Planet memory) {
        return _planets[tokenId];
    }
